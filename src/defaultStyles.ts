...
export const gerDefaultStyles = (defaulMargin?: number): string => {
  ...
  .barchart-container .x-tick { font-size: 11px; overflow: hidden; text-overflow: ellipsis; text-align: center; margin: 0 ${defaultGap/2}px; }
  ...
  .barchart-container .bar-column .bar { max-width: 50px; width: 100%; border-radius: 8px; background: #01adff; transition: height 0.4s ease; z-index: 3; }
